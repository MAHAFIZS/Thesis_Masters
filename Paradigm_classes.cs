...
public class paradigm_calculation
{
    ...
    /// <returns></returns>
    public int GetAxisGroup(int gesture, double angle, double[] group1, double[] group2)
    {
        ...
        else if (angle < group2[1] & angle > group2[0])  // pointing up 
        {
            return 2;
        }
        else if (angle > group1[0] & angle <= group1[1]) // pointing down
        {
            return 1;
        }
        return 0;
